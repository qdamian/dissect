...
@patch('dissect.modeling.dynamic.function_call.threading', autospec=True)
class TestFunctionCall:
    ...
    def test_init_creates_a_thread_entity_for_the_current_thread(self, threading):
        ...
        # Act
        FunctionCall(self.entity_id_generator, self.model)
    ...
    def test_on_call_it_ignores_it_if_the_function_is_unknown(self, _):
        ...
        function_call_modeler = FunctionCall(self.entity_id_generator, self.model)

        # Act
        function_call = function_call_modeler.on_call(frame_digest)
    ...
    def test_it_relates_nested_function_calls(self, _):
        ...
        # Act
        parent_function_call = function_call_modeler.on_call(fake('FrameDigest'))
        child_function_call = function_call_modeler.on_call(fake('FrameDigest'))
    ...
    def test_it_considers_returns_when_relating_nested_function_calls(self, _):
        ...
        # Act
        function_call_modeler.on_call(fake('FrameDigest'))
        child_function_call1 = function_call_modeler.on_call(fake('FrameDigest'))
        function_call_modeler.on_return(Mock())
        child_function_call2 = function_call_modeler.on_call(fake('FrameDigest'))
